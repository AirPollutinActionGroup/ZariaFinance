 ...
 *
 * <p>
 * Entity-type-conditional requirements (e.g. Aadhaar only for Individual;
...
public class CreateVendorRequest {
        ...
        @Pattern(regexp = "Individual|Proprietorship|Partnership|Pvt Ltd|LLP|Trust|Section 8", message = "Entity type is not a recognised value")
        ...
        @Pattern(regexp = "^$|Regular|Composition|SEZ", message = "GST registration type is not a recognised value")
        ...
        @Pattern(regexp = "Goods|Services|Consulting|Logistics|IT|Grantee-linked", message = "Vendor category is not a recognised value")
