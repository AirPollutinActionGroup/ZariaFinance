...
/**
 * Resolves organisational roles (designations) to the people who hold them
 * (Disbursement Rules §5). The deputy is a notification target only — nothing
 * here confers authority.
 */
public interface RoleDirectoryService {
    ...
    Optional<RoleDirectoryEntryDto> findByDesignationId(Long designationId);
}
