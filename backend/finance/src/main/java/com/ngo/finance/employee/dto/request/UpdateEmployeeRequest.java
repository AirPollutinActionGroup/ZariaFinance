...
/**
 * Request DTO for editing an existing Employee. The edit form always
 * resubmits the whole record (like create), so every field required on
 * create is required here too — this is a full replace, not a partial patch.
 */
@Data
@Builder
@NoArgsConstructor
